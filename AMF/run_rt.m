% ***************************************************************
% run_rt.m: the scripts to run experiments on response time data
...
numService = 4500;
timeSlices = 64;
dataPath = '../data/processedData/rtData/rt';
outPath = 'result/';
...
for i = 1 : length(density)
    ...
    for k = 1 : timeSlices
        outFile = sprintf('%s%02d_rtResult_%.2f.txt', outPath, k, density(i));
