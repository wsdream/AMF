...
----------------------------------------------------------------------------
List of contents of this package
----------------------------------------------------------------------------

dataProcess.m  - the script file to preprocess the data after unzip the 
                 downloaded raw data. The "processedData/rtData/" and 
                 "processedData/tpData/" will be generated, each involving
                 64 data matrices for each time slice
